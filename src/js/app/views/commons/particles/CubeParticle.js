...
function CubeParticle () {
  View.call(this);
}

CubeParticle.prototype = Object.create(View.prototype);
CubeParticle.constructor = CubeParticle;

CubeParticle.prototype.init = function () {
...
CubeParticle.prototype.open = function () {
  View.prototype.open.call(this);
  this.onResize();
  this.onOpen();
}

CubeParticle.prototype.close = function () {
  View.prototype.close.call(this);
  this.onClose();
}

CubeParticle.prototype.dispose = function () {
  View.prototype.dispose.call(this);
}

CubeParticle.prototype.onOpen = function () {
  View.prototype.onOpen.call(this);
  this.dispatchEvent(ViewEvent.OPEN);
}

CubeParticle.prototype.onClose = function () {
  this.dispatchEvent(ViewEvent.CLOSE);
}

CubeParticle.prototype.onResize = function (event) {
  
}

CubeParticle.prototype.onRender = function (event) {
  // if(this.count < 1){
